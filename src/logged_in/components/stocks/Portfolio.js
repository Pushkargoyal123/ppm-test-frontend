  ...
  useEffect(function () {
    ...
    const fetchPortfolioHistory = async () => {
      ...
      if (eventInfo) {
        ...
        resultportfolio = await postData("dreamNifty/portfolio/history", body);
      } else {
        resultportfolio = await getData("stock/portfolio/history/" + userData.id + "?ppmGroupId=" + groupId.group);
      }
