                    ...
                    !message ? <div className="ParentFlex">
                        ...
                        <MaterialTable
                            title=<ToolTip title="Back" component={() => <KeyboardBackspaceRoundedIcon
                                ...
                                onClick={() => props.setComponent(<Portfolio setUnderlinedButton={props.setUnderlinedButton} groupId={groupId.group} setGroupId={props.setGroupId} setComponent={props.setComponent} />)}
                            />} />
